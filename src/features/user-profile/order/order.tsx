...
const OrdersContent: React.FC<OrderTableProps> = ({
  deviceType: { mobile, tablet, desktop },...props
}) => {
...
export default  withApollo()(withStyles(styles, { withTheme: true })(inject("routingStore", "uiStore")(withOrders(OrdersContent))));
